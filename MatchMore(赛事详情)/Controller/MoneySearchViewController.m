...
@interface MoneySearchViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation MoneySearchViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title =@"组别奖金";
...
-(void)getData
{
    ...
    [manager GET:KMoneySearch_URL parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
