...
@interface NewMatchTableViewCell()
//头像
...
@implementation NewMatchTableViewCell
...
-(void)setModel:(NewMatchDataList *)model
{
    CGFloat space =10;
...
-(void)setEventLevel_text:(NewMatchDataList *)model
{
